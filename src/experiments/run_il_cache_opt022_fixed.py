...
# FIXED: disable drift contribution to budget
DRIFT_GAIN = 0.0
DRIFT_ALPHA_FLOOR_MULT = 0.7
# FIXED: disable score gate by allowing full candidate set
SCORE_GATE_TOP_PERCENT = 1.0
FILL_RATIO = 0.9
FILL_RATE = 0.05
# FIXED: disable miss-pressure and score-quality modulation
...
# FIXED: disable precision-based scaling
