...
def run_single_capacity(
    ...
    def _finalize_slot() -> None:
        ...
        total_guard_time_s += guard_time_s
        total_select_time_s += select_time_s
        slot_time_s = feat_time_s + score_time_s + guard_time_s + select_time_s + update_time_s
        ...
        slot_log = {
            ...
            "time_guard_s": float(guard_time_s),
